...
$y_{gj} | \_{gj} \sim Poisson(\lambda_{gj})$
...
$\sigma_{att} \sim Gamma(5,15)$, $\sigma_{def} \sim Gamma(5,15)$
...
```
The difference between proposed priors is not significantly different according to PSIS-LOO diagnostic. 
